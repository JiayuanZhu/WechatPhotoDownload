...
chatRoomNames = ['BBBBBB','okiki']     # in the real case we only need okiki
baseDir = "C:\\WORK\\Study\\itchat\\"  # Change the base folder for each deployed machine
...
def download_files(msg):
    for item in configs:
        ...
        if(msg['ToUserName'] == chatroom['UserName'] or msg['FromUserName'] == chatroom['UserName']):
            ...
            msg.download(filePath+msg.fileName)
